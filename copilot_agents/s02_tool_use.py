...
SYSTEM = f"You are a coding agent at {WORKDIR}. Use tools to solve tasks. Act, don't explain. DO NOT USE BUILT-IN TOOLS, ONLY THE ONES I GAVE YOU."
...
session = client.create_session(model=MODEL, system_message=SYSTEM, tools=TOOLS)
...
def agent_loop(messages: list):
    while True:
        response = session.send_messages(normalize_messages(messages))
